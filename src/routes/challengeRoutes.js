...
router.get('/challenges/challengeById/:id', challengeController.getChallengeById);
...
router.get('/challenges/completedChallenges/', challengeController.completedChallenges); // get all completed challenges for a user
